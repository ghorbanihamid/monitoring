...
<s:form namespace="/" id="globalErrorForm" name="globalErrorForm" theme="simple">
...
<h2 align="center"><s:text name="label.globalError"/></h2>
        ...
        <table border="0" cellpadding="0" cellspacing="0"  align="<s:text name="align.left" />" dir="<s:text name="dir.ltr" />" width="100%">
            ...
            <tr class="bodyElementsRows">
                <td align="<s:text name="align.left" />" dir="<s:text name="dir.ltr" />" class="actionErrorClass" width="100%">
                    ...
                    <p>
                    <h4><s:text name="error.common.exceptionName"/></h4>
                    <s:property value="exception" />
                    </p>
                    <p>
                    <h4><s:text name="error.common.exceptionStack"/></h4>
                    <s:property value="exceptionStack" />
                    </p>
                    <p><h5><s:text name="error.common.confirmInternet"/></h5></p>
                </td>
