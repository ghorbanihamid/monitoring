...
<s:form namespace="/" id="userWorkSheet" name="userWorkSheet" theme="simple">

    <s:div cssClass="type-text type-select ui-widget ui-widget-content ui-corner-all yform" cssStyle="width: 100%; height: 680px;vertical-align: top;">

        <%--<h2 align="center"><s:text name="student.registerStudentTitle"/></h2>--%>
        ...
        <%--<table border="0" cellpadding="0" cellspacing="0"  align="<s:text name="align.left" />" dir="<s:text name="dir.ltr" />" width="100%">--%>
            ...
            <%--<tr class="bodyElementsRows">--%>
                <%--<td align="<s:text name="align.left" />" dir="<s:text name="dir.ltr" />" class="actionMessageClass" width="100%">--%>
                    <%--<s:text name="student.studentSavedSuccessfully"/>--%>
                <%--</td>--%>
            <%--</tr>--%>
            <%--<tr class="bodyElementsRows">--%>
                    ...
                    <%--<table width="100%">--%>
                        <%--<tr class="bodyElementsRows">--%>
                            ...
                            <%--<td align="<s:text name="align.left" />" dir="<s:text name="dir.ltr" />" class="actionMessageClass">--%>
                                <%--<s:label id="studentId" name="studentId" cssStyle="font: bold; font-size: 12px; color: #3300ff "/>--%>
                            <%--</td>--%>
                        <%--</tr>--%>
                    <%--</table>--%>
                <%--</td>--%>
