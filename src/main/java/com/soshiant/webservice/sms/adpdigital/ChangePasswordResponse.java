...
public class ChangePasswordResponse  implements java.io.Serializable {
    private short changePasswordReturn;

    public ChangePasswordResponse() {
    }

    public ChangePasswordResponse(
           short changePasswordReturn) {
     ...
     */
    public short getChangePasswordReturn() {
        return changePasswordReturn;
    }
     ...
     */
    public void setChangePasswordReturn(short changePasswordReturn) {
        this.changePasswordReturn = changePasswordReturn;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            this.changePasswordReturn == other.getChangePasswordReturn();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        _hashCode += getChangePasswordReturn();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.adpdigital.com/services/messaging", ">changePasswordResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("changePasswordReturn");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.adpdigital.com/services/messaging", "changePasswordReturn"));
