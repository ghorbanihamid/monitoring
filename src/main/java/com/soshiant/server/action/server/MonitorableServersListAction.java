 ...
 * Time: 6:14 PM
 */
public class MonitorableServersListAction extends ActionSupport implements ServletRequestAware {

    Logger log = Logger.getLogger(MonitorableServersListAction.class);

    private String actionName;
    private String logMessage = "";


    private List<UserServers>    gridModel;
    private List<UserServers>    serverList;
    ...
    public List<UserServers> getServerList() {
        return serverList;
    }

    public void setServerList(List<UserServers> serverList) {
    ...
    public String showServerListInputForm() throws Exception {
        ...
        try {
            ...
            request.setAttribute(ServerConstants.OBJECT_MONITORABLE_SERVERS, resultObject.getResultData());
    ...
    public String fetchMonitorableServersOfUserList() throws Exception {
        ...
        try {
            ...
            this.serverList = (List<UserServers>) resultObject.getResultData();
...
//            session.put("seminarReservationListSession", seminarReservationList);
    ...
    public ResultObject getMonitorableServersOfUserList() throws Exception {
        ...
        try {
            ...
            List<UserServers>  monitorableServerList = (List<UserServers>) facadeResult.getData();
    ...
    */
    ...
    public List<UserServers> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<UserServers> gridModel) {
